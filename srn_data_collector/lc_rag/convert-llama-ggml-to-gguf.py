# Code obtained from : https://github.com/ggerganov/llama.cpp/blob/master/convert-llama-ggml-to-gguf.py
...
def handle_args():
    ...
    parser.add_argument(
        "--eps", default="5.0e-06", help="RMS norm eps: Use 1e-6 for LLaMA1 and OpenLLaMA, use 1e-5 for LLaMA2"
    )
    parser.add_argument(
        "--context-length",
        "-c",
...
def main():
    ...
    converter = GGMLToGGUF(
        model, data, cfg, params_override=params_override, vocab_override=vocab_override, special_vocab=special_vocab
    )
    converter.save()
